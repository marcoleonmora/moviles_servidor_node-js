...
const storage = new Storage({
    projectId: "repositorio-apps-moviles-sena", // ID del proyecto COPIADO de Firebase
    keyFilename: './serviceAccountKey.json'
});

// RUTA COPIADA DE FIREBASE STORAGE, incluir el slash final
const bucket = storage.bucket("gs://repositorio-apps-moviles-sena.appspot.com/");
